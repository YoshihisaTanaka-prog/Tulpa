...
class DiariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diary" do
    assert_difference("Diary.count") do
      post diaries_url, params: { diary: { text: @diary.text, user_info_id: @diary.user_info_id } }
    end
  ...
  test "should update diary" do
    patch diary_url(@diary), params: { diary: { text: @diary.text, user_info_id: @diary.user_info_id } }
