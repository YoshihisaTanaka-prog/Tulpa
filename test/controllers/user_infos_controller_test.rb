...
class UserInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_info" do
    assert_difference("UserInfo.count") do
      post user_infos_url, params: { user_info: { is_main: @user_info.is_main, is_need_meal: @user_info.is_need_meal, is_need_sleep: @user_info.is_need_sleep, name: @user_info.name, user_id: @user_info.user_id } }
    end
  ...
  test "should update user_info" do
    patch user_info_url(@user_info), params: { user_info: { is_main: @user_info.is_main, is_need_meal: @user_info.is_need_meal, is_need_sleep: @user_info.is_need_sleep, name: @user_info.name, user_id: @user_info.user_id } }
